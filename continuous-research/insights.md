...
**Source:** OODA cycle 214 — Every `ce-code-review`, Böckeler, Husain/Shankar, Intercom, AgentAbstain, Proof of Execution, and C-Trace
**Date:** 2026-09-06

---

## The Ticket Is a Case File, Not a Permission Slip

**Thesis:** Safe DevSecOps automation compounds evidence and prepares actions; it does not let a ticket status manufacture authority or proof of resolution.

At enterprise scale, a security ticket is a read model over several sources of truth: the detector and its version, the repository commit and pull request, the workflow execution, the cloud resource's observed state, and the accountable owner. The agent may enrich and connect those records. It must not convert its own confidence—or a detector's disappearance—into permission to merge, execute, or close.

The enforceable design separates identities: observe, prepare, verify, authorize, execute. Autonomy expands per narrow action class only after shadow results, correct abstentions, a one-target canary, independent postconditions, and rollback evidence. The human gate also serves as the learning interface: accept, reject, edit, and rationale ground the next candidate rule in operator judgment. The execution loop handles the ticket; the learning loop proposes a change to the handler. Central promotion then requires provenance, scope, backtest, review, versioning, and expiry.

**The implication for CTOs:** Automate the evidence chain, not the authority chain. Make `resolved` a computed outcome of independent evidence, and keep `contained`, `accepted risk`, `analyzer handoff`, and `no longer reported` visibly different.

**Applies to:** Agents 101 modules 9–10, DevSecOps operating model, GitHub/AWS governance, security automation
**Sources:** [Hamel Husain and Shreya Shankar on human-first trace review](https://hamel.dev/blog/posts/evals-faq/how-many-examples-do-i-need-for-an-eval.html) — [practitioner direct], 2026-09-01; [GitHub rulesets](https://docs.github.com/en/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/available-rules-for-rulesets), [GitHub environments](https://docs.github.com/en/actions/reference/workflows-and-actions/deployments-and-environments), and [AWS Systems Manager actions](https://docs.aws.amazon.com/systems-manager/latest/userguide/automation-actions.html) — [vendor documentation], checked 2026-09-06; [Semgrep Memories](https://semgrep.dev/blog/2026/inside-the-ai-memories-security-teams-are-writing/) — [vendor press release], 2026-05-06; [GitLab work item #620336](https://gitlab.com/gitlab-org/gitlab/-/work_items/620336) — [practitioner direct], observed 2026-08-22. OODA cycles 215–217 carry the full capability composition and counter-test.
**Evidence boundary:** L2 overall. The control primitives and memory pattern are L0 vendor capability; the strongest independent evidence is one reproducible false-closure incident. The complete cross-system operating design remains an inference, not a converged deployment pattern.
**Date:** 2026-09-06
...
**Sources:** [Claude Code memory](https://code.claude.com/docs/en/memory) — [vendor documentation], checked 2026-09-07; [Bad Memory](https://arxiv.org/abs/2607.14611), [AuthMem-Bench](https://arxiv.org/abs/2608.01679), [SkillMisevo](https://arxiv.org/abs/2608.12851), and [TANGLE](https://arxiv.org/abs/2608.13921) — [academic/research], Jul–Aug 2026. Full evidence in OODA cycle 218.
