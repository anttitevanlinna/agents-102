...
**Target: 400–700 words.** Current student-facing body (above `<!-- maintainer -->` cut): ~900 words — four prompts inline push the total up. Honest. Module 2 exercise ran ~900 and shipped APPROVE WITH TODOs on length. Expect the same verdict here; the prompts earn their keep.
