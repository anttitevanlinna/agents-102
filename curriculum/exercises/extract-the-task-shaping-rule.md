...
**Emphasis budget (`check_slides.md §9`):** bullet leads plain, with one exception — Phase 5's three Boy Scout category names (**Planning gaps.** · **Conflicting information.** · **Other context.**) are bolded checklist-item handles inside the ≲5-word cap. That slide is scanned for a match rather than read through, so §9's count waiver for scanned surfaces carries the three-on-one-slide count; the bullets are Antti's, per the Phase 5 note below. Widget chrome (`**Time:**`, `**What you do:**`, `**What you build:**`, `**The point:**`, `**What happened:**`) untouched, per `theory-plan.md § Slide format — emphasis budget` + `check_slides.md §9`.
...
**Quality:** compendium-audited 2026-09-05 (writing@324b81d7 story@324b81d7 technical@324b81d7 behavior@d065f8bc pedagogy@324b81d7 strategy@324b81d7 slides@9edae2ef)
- judges @324b81d7: writing PASS (4 todos see instances/ae101--exercise--extract-the-task-shaping-rule.writing.json), story PASS, technical PASS (2 todos see instances/ae101--exercise--extract-the-task-shaping-rule.technical.json), behavior PASS, pedagogy PASS (2 todos see instances/ae101--exercise--extract-the-task-shaping-rule.pedagogy.json), strategy PASS, slides PASS (1 todo see instances/ae101--exercise--extract-the-task-shaping-rule.slides.json)
- cohorts: none yet
