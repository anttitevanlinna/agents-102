...
Darragh Curran (Intercom, now Fin) references Ramp approvingly in his 2x memo, but **not this post.** Corrected 2026-08-02, verified by opening the memo: the only Ramp mention reads *"I respect and applaud large organizations who have also gone really hard (e.g. this wonderful post shared a few days ago by Ramp)"*, and the link goes to **Benjamin Levick** (Ramp, Head of Product Ops), [*"What Happens When You Tell a Thousand People to Build AI"*](https://www.linkedin.com/pulse/what-happens-when-you-tell-thousand-people-build-ai-benjamin-levick-oorfe/) `[practitioner direct]`. The strings *Geoff Charles* and *geoffintech* do not appear in the memo at all. **This file previously asserted that Curran cited Charles's post; that was never true and was carried unverified.**

**Level: L2. Downgraded 2026-08-02 — this file previously read "Level 3 convergence signal (two independent practitioners)."** **(a) Two is not ten.** The ladder sets L3 at 10–20 independent practitioners; two strong single-org cases are L2 however well they match, and this reason alone is sufficient. **(b) They are not blind to each other, though the mechanism is weaker than this file first claimed.** The 2026-08-02 downgrade originally justified (b) with *"Curran cites Charles's post"* — built on the unverified sentence above, and false. What is true, verified: Curran read and applauded a **different** Ramp author's account of the same initiative days before publishing. The two orgs were in dialogue; they were not two strangers arriving at one answer. That still weakens *independent*, but it is a softer claim than a direct citation and must not be restated as one. Do not restore either the L3 framing or the Charles-citation claim; if a third and fourth org publish the same moves with no sight of each other, revisit.

> **Second Ramp source, verified 2026-08-29.** Levick's post (linked above) is confirmed as the origin of the figures itemized here — read first-hand, it states them verbatim: 99.5% team-active / 84% weekly coding-agent use, 6,300% YoY usage increase, 1,500+ apps shipped by 800+ builders in six weeks, 12% non-engineer PR share, 700 hackathon participants coached by 100 staff, 1,000+ in #ramp-uses-ai, 40+ team channels at 20,000 messages/month, 40–50+ at weekly office hours. The Scale Claims table's **350+-skills-shared row was not surfaced by this fetch and stays unverified.** The previously flagged 99.7%-vs-99.5% divergence does not exist in the source — Levick's post says 99.5%, matching this file exactly; that number was never actually sourced from Levick's text and should not have been asserted as a live discrepancy. Verbatim agreement between Charles and Levick is **one company agreeing with itself** `[practitioner direct, commercial interest]` — both are Ramp voices, in dialogue per the L2 note above, so this confirms citation accuracy, not the numbers. `[checked:2026-08-29 result:OK due:2026-10-08]` (evidence claim, due = pub date 2026-04-08 + 6mo)
...
- **Shape-match with Intercom (2x side)** *(renamed from "Convergence with…" 2026-08-02 — the header was doing the overclaiming after the body was corrected)***:** The shape of the playbook matches — dedicated platform team (Intercom: team-2x / Ramp: central team), internal Claude Code derivative (Intercom's plugin marketplace / Ramp's Glass + Dojo), uneven distribution made visible (Intercom: top 5% = 6x median / Ramp: L0–L3 ladder), cost-posture (both: don't optimize spend, optimize leverage), public accountability (both: declared goal + transparency memo). **Two practitioners, one of whom cites the other — L2, and see the level note at the top of this file.** The shapes matching is the interesting part and it is not a convergence count: a matching *shape* is what you would expect from two teams reading each other, which is exactly what happened here.
