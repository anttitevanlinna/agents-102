...
|--------|------|----------------|-----------------|-------------------------------|
| **Andrej Karpathy** | Ex-OpenAI, educator | X.com, YouTube | Reversed on agents for coding (Dec 2025). His trajectory = the coding agent story. | Coding agents work. Everything else is "slop." (Dec 2025) |
...
**Gap: We have zero named Nordic practitioners on this roster.** This is a research priority — find the builders in the Nordics who are actually deploying agents (not the consultancies selling frameworks).
