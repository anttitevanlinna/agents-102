...
produces:
  - id: working-tree-scaffold
    location: working dir (prework/, memory/, sources/, agents/, {{artifact:project-skills}}/, module-4/policies/)
    consumed-by:
...
prework/, memory/, sources/, agents/, {{artifact:project-skills}}/, and module-4/policies/.
