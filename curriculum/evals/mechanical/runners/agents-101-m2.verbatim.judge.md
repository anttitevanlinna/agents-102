# Judge — Agents 101 M2 chain verbatim
...
- **Scratch:** `/Users/anttitevanlinna/Projects/agents-102/curriculum/evals/mechanical/scratch/agents-101-m2`
- **Actor transcript:** `<ACTOR_TRANSCRIPT_PATH>`
- **Actor report:** `curriculum/evals/mechanical/instances/agents-101-m2-verbatim-actor-report.md`
- **Actor scrollback:** `curriculum/evals/mechanical/instances/agents-101-m2-verbatim-actor-scrollback.md`
- **Prompt files:** `/tmp/prompts/name-your-challenge/prompt-00{1,2}.txt` + `/tmp/prompts/build-your-challenge-memory/prompt-00{1..9}.txt`
- **Mock library:** `/tmp/agents-101-mocks/{confluence,onedrive,practitioners}/`
...
- **PF1.** `bin/runner-mapping-check.sh runners/agents-101-m2.verbatim.actor.md curriculum/exercises/name-your-challenge.md`. PASS on exit 0; FAIL on any non-zero exit.
- **PF2.** `bin/runner-mapping-check.sh runners/agents-101-m2.verbatim.actor.md curriculum/exercises/build-your-challenge-memory.md`. PASS on exit 0; FAIL on any non-zero exit.
...
Write `curriculum/evals/mechanical/instances/agents-101-m2-verbatim-judge-report.md`:

```markdown
# Judge report — Agents 101 M2 verbatim
