# Actor — Agents 101 M3 synthesizer (main session)
...
**Prompt:** `/tmp/prompts/three-retrievers-one-curator/prompt-005.txt`.
...
Write `.../instances/agents-101-m3-verbatim-synthesizer-report.md`:
...
- Read mock-library files directly (`/tmp/agents-101-mocks/*`).
