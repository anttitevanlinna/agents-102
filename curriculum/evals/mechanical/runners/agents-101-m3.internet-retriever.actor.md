# Actor — Agents 101 M3 internet retriever
...
Mock practitioner articles at `/tmp/agents-101-mocks/practitioners/`. Substitute Maija's confirmation:
...
Write `.../instances/agents-101-m3-verbatim-internet-retriever-report.md`:
...
- Read `/tmp/agents-101-mocks/confluence/` or `/tmp/agents-101-mocks/onedrive/`.
