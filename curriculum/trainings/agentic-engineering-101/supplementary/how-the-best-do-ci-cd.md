...
- Peter Yang on Geoff Charles, [*Inside Ramp: how a $32B company runs on AI agents*](https://creatoreconomy.so/p/inside-ramp-the-32b-company-ai-agents-geoff-charles)
- Charity Majors on why agents need fast production observability. (Her 2026-03-09 post at charity.wtf now returns 404; cite the argument, not the link, until a live URL is found.)
...
**Quality:** compendium-audited 2026-08-28 (writing@e11bbeb4 story@e11bbeb4 technical@8cc00874 behavior@da65157 pedagogy@1abb84c6 strategy@da65157 slides@e11bbeb4)
