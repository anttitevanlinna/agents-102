...
- judges @3552e8c2: writing PASS, story REVISE (see-instances/claude-basics--build-your-system.story.json), technical REVISE (see-instances/claude-basics--build-your-system.technical.json), behavior REVISE (see-instances/claude-basics--build-your-system.behavior.json), pedagogy PASS, strategy PASS, slides PASS (2 findings see instances/claude-basics--exercise--build-your-system.slides.json)
