...
**Important:** if the buying organisation has published its own AI-use policy, this baseline is replaced. The customer-specific `company-ai-policy` skill (built separately, outside this repo) carries the actual rules.
