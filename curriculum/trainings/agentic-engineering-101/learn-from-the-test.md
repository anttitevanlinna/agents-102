...
- `[checked:2026-08-15 result:OK due:2026-01-14]` https://ghuntley.com/ralph/ — [practitioner direct] Geoffrey Huntley's original Ralph account describes the repeated agent loop named in the challenge. fallback: describe a minimal fresh-context coding loop without the Ralph name.
