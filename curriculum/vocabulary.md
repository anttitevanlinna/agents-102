...
| **workflow** | skills in the right order around one task — student-facing carrier is the skills-to-workflow slide in `composing-the-workflow` (variety of wiring, then the seam check); no one-sentence definition line is owed | the concept is **skills-to-workflow composition**: variety first (called by hand / chained through files / authored wiring), one documented kit as specimen, never a closed field taxonomy | `composing-the-workflow` |
