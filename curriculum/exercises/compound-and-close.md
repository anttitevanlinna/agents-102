...
- judges @64d17eea: writing PASS, story PASS, technical PASS, behavior PASS (4 todos see instances/ae101--exercise--compound-and-close.behavior.json), pedagogy PASS, strategy PASS, slides PASS (2 todos see instances/ae101--exercise--compound-and-close.slides.json)
**Meta (trainer):**
