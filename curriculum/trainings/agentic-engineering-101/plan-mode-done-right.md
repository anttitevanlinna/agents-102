...
- judges @324b81d7: writing PASS (2 findings see instances/ae101--module--plan-mode-done-right.writing.json), story PASS (1 finding see instances/ae101--module--plan-mode-done-right.story.json), technical PASS, behavior PASS, pedagogy PASS (1 finding see instances/ae101--module--plan-mode-done-right.pedagogy.json), strategy PASS, slides PASS
