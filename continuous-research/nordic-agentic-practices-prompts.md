...
| Platform Agents | Expansion (Cycle 60) | 2026-03-23 | 3 new platforms + observability + Nordic governance | **NEW:** Anthropic enterprise push (Cowork + Intuit MCP + $100M partner network). Google Agent Builder governance story (IAM, VPC, threat detection). AWS Bedrock AgentCore deepened (Robinhood, Totemia). Agent observability as infrastructure category (LangSmith, Arize, Langfuse). Nordic governance convergence (AI Act + NIS2 + GDPR simultaneously). |
| Practitioner Signals | Expansion (Cycle 60) | 2026-03-23 | Context engineering deepened + failure taxonomy confirmed | Context engineering approaching L2-3 (QCon, NeurIPS, Inkeep, StartuphubAI — 7-9 signals). Agent failure taxonomy CONFIRMED at L3 (15+ sources). Key: 88% never reach production, 68% need human within 10 steps, $500K pilot failure cost. "Constraint over freedom" = architectural insight. |
| Convergence Update | Expansion (Cycle 60) | 2026-03-23 | 1 new L3 pattern + 1 upgraded | Agent production failure taxonomy CONFIRMED at L3 (15+ independent sources). Context engineering upgraded to L2 approaching L3 (7-9 signals). A2A still zero deployment despite 150+ organizations. MCP at 10K servers but coding-only. |
| Practitioner Signals | Cycle Update (Hour 18) | 2026-03-23 | Karpathy major update + Chase corrected + Willison 2 new signals | Karpathy: zero coding since Dec 2025, parallel agent workflows, "agentic engineering" as discipline. Chase: Deep Agents launch, NVIDIA partnership, "harness engineering" pivot — previous "no shift" was wrong. Willison: chardet relicensing (agent legal risks), agentic engineering fireside chat. "Agentic engineering" approaching L3 convergence as named discipline. Context engineering confirmed at L3. |
| Platform Agents | Cycle Update (Hour 18) | 2026-03-23 | Claude Cowork reviews + D365 details + Adecco deal | Claude Cowork: practitioner reviews exist (6-8hr/week savings, security gaps — no audit logging, known CVEs). Microsoft D365 Release Wave 1: GA April 1, MCP integration in finance/operations. Salesforce: Adecco unlimited Agentforce deal (50% revenue target). A2A v0.3 released, still zero deployments. Google Agent Builder: governance tools shipping, zero customer evidence. |
| Nordic Deployments | Cycle Update (Hour 18) | 2026-03-23 | Klarna fuller picture + Equinor confirmed + BCG Nordic data | Klarna: Uber-style hybrid workforce model, 853 FTEs equivalent, $60M saved, $19.65B IPO. 55% of AI-layoff companies regret it. Equinor: Skryseth NHO speech confirms "agentic AI" direction. BCG: only 4% Nordic companies achieve strong AI returns. No new Nordic companies found. Gjensidige Eva results still absent after 11 months. |
| Platform Agents | Cycle Update (Hour 20) | 2026-03-23 | Sana/Workday launch + Agentforce Sales + Agent 365 governance + SAP/Oracle friction | **MAJOR:** Sana from Workday launched March 17 ($1.1B acquisition). 3 Nordic early adopters named (Berner FI, Cheffelo SE, Telavox SE). Agentforce Sales: first non-CS use case (6 sales agents GA). Microsoft Agent 365: $15/user governance SKU (GA May 1). D365 Payables Agent + MCP in ERP. Agentforce SMB: first practitioner review (L2). SAP/Oracle community friction documented. "AI Paywall" anti-pattern emerging (L2). Copilot Cowork: 26th cycle with zero reviews. ServiceNow: still zero evidence 4 weeks post-launch. Morgan Stanley MCP production (L2, 100+ APIs, QCon). Spotify multi-agent ads production (L2, ADK+Gemini). ACP absorbed into A2A. Google ADK GA. Okta agent identity product. Enterprise AI skepticism at L3 convergence. |
| All Tracks | Cycle 70 (Hour 18) | 2026-03-24 | NBIM major signal + Agentforce hard numbers + agentic engineering L3 | **MAJOR:** NBIM ($2.1T sovereign wealth fund) using Claude, $100M/year savings, targeting $400M, no layoffs — strongest Nordic augmentation case. Agentforce first with hard adoption data (18.5K customers, $540M ARR, 330% YoY). "Agentic engineering" confirmed L3 (conferences + academic workshops + 10-20+ signals in 6 weeks). NEW platforms: OpenAI Frontier ($110B round), NVIDIA NemoClaw (alpha). ServiceNow no longer zero reviews (diginomica). D365 Payables Agent detailed as genuinely agentic. Gjensidige now 3 agents (Eva, Sofie, Frank) — still no outcomes. Nordic workforce split emerging: Cut (Klarna, Nordea) vs. Augment (NBIM, Equinor). Mollick: "hidden adoption" = structural gap. Agent legal/IP risk as new category (chardet). |
| All Tracks | Cycle 71 (Hour 20) | 2026-03-24 | Computer Use wars + Cowork 36th zero + Nordic gap validated | First independent head-to-head of 4 computer-use tools (Perplexity won both tasks). Copilot Cowork: 36th consecutive zero reviews. Nordic market gap independently validated by AI consultant blog + Global AI Index declines (Finland 10→15, Sweden 17→25). |
| All Tracks | Cycle 72 (Hour 22) | 2026-03-24 | Shadow AI governance + SAP Joule survey + MCP roadmap + new HR/finance platforms | Nudge Security: first shadow AI agent discovery product (agent security approaching L3). SAP Joule: Horvath survey — 60% of companies "not agile enough," Nestle at PoC stage. MCP 2026 roadmap: enterprise scaling friction documented (5,800+ servers, 97M+ SDK downloads). OpenAI-AWS: stateless/stateful infrastructure split ($110B deal). NEW: Confirm HR agent platform, Board Finance agents. Copilot Cowork 37th zero. Equinor first to name "agentic AI" publicly. AI Finland: agentic AI as 2026 theme. |
