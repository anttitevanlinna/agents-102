...
- judges @324b81d7: writing PASS (2 todos see instances/ae101--module--plan-mode-done-right.writing.json), story PASS (1 todo see instances/ae101--module--plan-mode-done-right.story.json), technical PASS (1 todo see instances/ae101--module--plan-mode-done-right.technical.json), behavior PASS, pedagogy PASS (1 todo see instances/ae101--module--plan-mode-done-right.pedagogy.json), strategy PASS (1 todo see instances/ae101--module--plan-mode-done-right.strategy.json), slides PASS
