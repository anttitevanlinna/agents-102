...
- Most of the human attention that made the re-send land came before you pressed send: diagnosing failure modes, mapping validations, building the verifier, assembling reference and plan.md. The ratio this training takes from Kieran Klaassen's compound-engineering posture: roughly 80% of human attention on planning and review, 20% on execution.
...
- As agent runtime becomes easier to add, human attention becomes the scarce resource. Spend it where it changes the outcome: shaping the task, defining the checks, and reviewing the result.
...
**Quality:** compendium-audited 2026-08-04 (writing@93bb807 story@5fc7188 technical@1c765f2 behavior@1c765f2 pedagogy@5fc7188 strategy@1c765f2 slides@93bb807)
