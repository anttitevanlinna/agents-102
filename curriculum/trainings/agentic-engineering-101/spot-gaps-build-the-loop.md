...
**KC bullet 6's subtraction clause is the generalisation's one reminder-slot home (2026-08-20, `669c4dbf`, buried-gold item):** *"Encoding subtracts as well as adds: the durable shape is add, sharpen, delete."* is not a duplicate of the exercise's half-life bullet — the exercise motivates one cut at the moment of use; this line is the doctrine the reminder slot owes, and it survived the 2026-08-23 revert wave that removed the other three gold edits. Placement is settled: `theory-plan.md` § Rule-load ceiling (*"M5 owns gate decay; M6's subtraction beat stays half-life-grounded"*, Antti-placed 2026-08-19); an M5 relocation was reconsidered and dropped 2026-08-28. Lean passes keep the clause.
...
**Quality:** compendium-audited 2026-08-29 (writing@4a722813 story@0e4f7c9e technical@8cc00874 behavior@1c765f2 pedagogy@b55cd28b strategy@0e4f7c9e slides@297eb2f9)
