...
- `"Joona Honka" Berner Sana AI 90% adoption 400 ChatGPT licenses`
- `"Joona Honka" "6300 hours" Berner AI`
- `"Strawberry" "36,000 Hours Saved" "Agentic AI"`
- `"Kari Anna Fiskvik" "Scout AI"`
- `"Evelyn Piros-Read" "Scout AI" Strawberry`
- `"Danfoss" "Go Autonomous" "Carlos Garcia" "order intake"`
- `"Autonomous Commerce Summit" "Danfoss" "Nilfisk" "Grundfos" "VELUX" "Mediq"`
- `"Nordic" "AI agents" "CTO" "manufacturing" "2026" practitioner direct`
...
### Strawberry qualifies on size and has measured hours, but evidence is consultant-led and more RAG-assistant than team-throughput playbook

**Source:** https://www.devoteam.com/me/success-story/case-studies-strawberry-agentic-ai/ — [vendor case study]
...
**Date:** Current page crawled Apr/May 2026; exact publication date not exposed in fetched text.
**Agent level:** team / company knowledge layer
**What:** Earlier Strawberry case material gives a more bounded result: 20-30% reduction in new-staff training time and transformation of fragmented information into a centralized knowledge platform. This is useful but looks like a knowledge-assistant adoption case, not an agentic institutional-throughput playbook.
**Evidence level:** Level 0 as vendor case; Level 2 potential due named operator quotes.
**Key claims:** 20,000+ employees; training time reduction; Scout trusted by employees.

### Danfoss qualifies on scale and industry, but the evidence is vendor-led

**Source:** https://goautonomous.io/news/articles/danfoss-streamlines-order-intake-with-ai/ — [vendor case study]
**Date:** 2025-01-29 (historical context only)
**Agent level:** function / operations
**What:** Danfoss is a 42,000-person Danish manufacturing company with a named practitioner, Carlos Garcia. The workflow shape is strong: email orders, attachments, SAP validation, autonomous checks, exception routing, global rollout. But the source is old and vendor-led.
**Evidence level:** Level 0 as vendor case study; watch target only.
**Key claims:** Named practitioner; global scale; order intake automation; human-in-loop exception handling.

**Source:** https://goautonomous.io/autonomous-commerce-blueprint/how-fast-can-autonomous-commerce-execute/ — [vendor product page]
**Date:** 2026-04-28
**Agent level:** function / operations
**What:** Go Autonomous claims Danfoss processes orders in under one minute across 26 countries and gives platform-wide benchmarks such as 57-second median execution and 99% first-time-right. This refreshes the Danfoss signal, but still from the vendor.
**Evidence level:** Level 0 vendor claim.
**Key claims:** Danfoss across 26 countries; order execution under one minute; benchmark metrics.

### Sana/Workday Nordic quotes remain vendor-sourced

**Source:** https://www.prnewswire.com/news-releases/introducing-sana-from-workday-superintelligence-for-work-that-finds-answers-takes-action-and-automates-workflows-302715971.html — [vendor press release]
**Date:** 2026-03-17
**Agent level:** company
**What:** Workday's Sana launch includes Nordic customer quotes from Berner, Cheffelo, and Telavox. Joona Honka says Berner reached 90% adoption and retired 400 ChatGPT licenses in 40 days; Anton Nytorp says Cheffelo made Sana its AI backbone; Alexander Bergstrom frames the shift as assuming Sana can handle 80% of execution. These are useful targets, but all are embedded in a vendor launch.
**Evidence level:** Level 0; target list for practitioner follow-up.
**Key claims:** Three named Nordic practitioners/customers; no independent or practitioner-owned write-up found in this scan.
