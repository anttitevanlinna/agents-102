...
**View summary:** You read one real ticket, have the agent reverse-engineer the team's field conventions from it, and close the bug's ticket with a close-out note written in that register. Two artifacts: bug rules headed for the rules file, and a close-out note in the team's tracker.
