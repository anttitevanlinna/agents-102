...
**Nordic signal:** Klarna is the standout Nordic case -- not as a user of product/strategy agents, but as a company building agentic infrastructure (Agentic Product Protocol) that reshapes how product discovery works. Nordea is developing agentic experiences internally but these are customer-facing chatbots, not product strategy tools. IKEA's AI investments are in logistics and design tools, not product strategy agents. The assessment: Nordic companies are not visibly ahead (or behind) in deploying agents for product/strategy work. This domain is thin globally, and thin in the Nordics.
