...
**CYCLE 164 UPDATE — Sierra: $200M ARR (May 2026), 72% autonomous resolution (Q1 2026), $950M Series E, Agent OS expanding from CS to sales + engagement; Legora: Baker McKenzie Australian rollout July 2026 (>1,900 lawyers), second firmwide top-5-law-firm deployment in <3 months; Decagon $35M ARR data now [STALE — October 2025]; Harvey: Sonnet 5 deployment June 30 (confirmed cycle 163); GPT-5.6 Sol creates model-choice dimension for AI-native CS platforms.**

**Sierra crosses $200M ARR — fastest AI-native CS company to this milestone.** $200M ARR in May 2026 (up from $100M November 2025, $130M end 2025, $26M end 2024). Trajectory: $0 to $100M in 7 quarters (February 2024 launch); then $100M to $200M in approximately 2 quarters — acceleration, not deceleration. $950M Series E (GV + Tiger Global, May 2026) at $15B valuation; total capital $1.585B. Operational metric: **72% autonomous resolution rate in Q1 2026** (up from ~55% in 2024) — this is the strongest independently cited CS-agent resolution metric in this KB. Scale: 40%+ of Fortune 50; agents handling "billions of interactions" (vendor language, unverifiable, but revenue trajectory validates real deployment scale). Named sectors (not named companies): insurance claims processing, mortgage origination/refinancing, subscription management, healthcare revenue cycle management. Strategic expansion: Agent OS moving from customer support → sales and engagement workflows. Half of customers have revenue >$1B. The 11x implosion (cycle 1) was the failure ceiling; Sierra is the current success ceiling — both exist simultaneously in this category. ([techcrunch.com May 4 2026](https://techcrunch.com/2026/05/04/sierra-raises-950m-as-the-race-to-own-enterprise-ai-gets-serious/) — [domain trade publication]; [sacra.com 2026](https://sacra.com/c/sierra/) — [practitioner analysis])

**Legora: Baker McKenzie Australia July 2026 (>1,900 lawyers) — fastest legal AI firmwide adoption curve tracked.** Baker McKenzie announced global Legora deployment May 2026. Australian operations specifically live July 2026: >1,900 lawyers and staff. Six global practice groups: transactional, banking and finance, tax, dispute resolution, employment and compensation, commercial. Use cases: document review and extraction, document comparison, multi-document editing/drafting/redlining, checklist preparation. Legora legal engineers co-building custom workflows alongside Baker McKenzie's Applied AI practice and Practice Innovation Lawyers. Pattern: Legora now has two firmwide deployments at top-5 global law firms (Baker McKenzie + BCLP) in under three months — this is the fastest firmwide legal AI adoption curve in this knowledge base. Nordic note: Legora is Swedish-origin but both firmwide deployments are non-Nordic (global/Australian + UK); no Nordic law firm firmwide Legora deployment found this cycle. ([bakermckenzie.com May 2026](https://www.bakermckenzie.com/en/newsroom/2026/05/baker-mckenzie-deploys-legora) — [vendor press release + firm newsroom]; [globallegalpost.com 2026](https://www.globallegalpost.com/news/baker-mckenzie-announces-global-rollout-of-legal-ai-platform-legora-9388973) — [domain trade publication])

**Decagon ARR data now stale (October 2025); $4.5B valuation January 2026 is most recent confirmed figure.** Last published Decagon ARR: $35M (October 2025, Sacra). Valuation: $4.5B (January 2026, $250M Series D, Coatue + Index Ventures). 100+ enterprise customers (F100 sectors). No July 2026 ARR published in any channel — Sacra not updated. Given 4x YoY growth rate at October 2025, current ARR is likely materially higher but unverifiable. Named customers confirmed: Notion, Duolingo, Eventbrite, Bilt, Avis Budget Group, Block, Deutsche Telekom. ([sacra.com 2026](https://sacra.com/c/decagon/) — [practitioner analysis]; [techcrunch.com Mar 2026](https://techcrunch.com/2026/03/04/decagon-completes-first-tender-offer-at-4-5b-valuation/) — [domain trade publication])

**CTO competitive frame update:** GPT-5.6 Sol GA July 9 creates a new model-choice dimension for AI-native CS platforms. Platforms using Fable 5 (Sierra, likely) now face a cost question: Sol is 40-50% cheaper with leading Coding Agent Index scores. CS agents are largely bounded tasks — Sol's performance profile is a natural fit. Watch: whether any AI-native CS platform publicly migrates from Fable 5 to Sol for cost optimization. This would be the first public evidence of frontier CS agent platforms making model-choice decisions on cost grounds rather than capability grounds.
