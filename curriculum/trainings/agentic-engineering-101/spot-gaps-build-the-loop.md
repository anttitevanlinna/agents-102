...
**KC bullet 6's subtraction clause is the generalisation's one reminder-slot home (2026-08-20, `669c4dbf`, buried-gold item):** *"Encoding subtracts as well as adds: the durable shape is add, sharpen, delete."* is not a duplicate of the exercise's half-life bullet — the exercise motivates one cut at the moment of use; this line is the doctrine the reminder slot owes. Placement is settled: `theory-plan.md` § Rule-load ceiling (*"M5 owns gate decay; M6's subtraction beat stays half-life-grounded"*, Antti-placed 2026-08-19); M5 is not this clause's home (2026-08-28). Lean passes keep the clause.
