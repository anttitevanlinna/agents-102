# Eval Instance — Agents 101 / Grounded (lecture)
...
**Module:** M5 — Output Quality and Hallucination Control (`trainings/agents-101/output-quality.md`)
...
Enables these Bloom-tagged LGs from `trainings/agents-101/output-quality.md`:
