...
OneDrive mocked at `/tmp/bootstrap-mocks/onedrive/`. When the prompt asks for clues, substitute Maija's answer:
...
Write `.../instances/bootstrap-m3-verbatim-docs-retriever-report.md`:
