...
- `[checked:2026-07-30 result:OK due:2027-01-30]` https://simonwillison.net/2025/Sep/30/designing-agentic-loops/ — [practitioner direct] (Willison, 2025-09-30). Outside the 6-month window by decision: named framing piece, dated in body, same treatment as the Cherny video exception in `getting-going.md`. Carve-out invoked is §7 (named framing piece), NOT §2a (durable account) — the piece describes a general technique, not a specific completed event, so 2a does not fit. **This is the module that owns the check** — `run-the-first-experiment.md` names the same URL in body and delegates here. fallback: drop the pre-read; Module 4 stands alone.
...
**Quality:** compendium-audited 2026-08-02 (writing@9089694 story@ffc64f9 technical@9089694 behavior@1c765f2 pedagogy@1c765f2 strategy@ffc64f9 slides@9089694)
...
- **Session runtime:** 2h00 (Connections 10 / Open the side quest 5 / Lecture 10–12 / Exercises 20+20+18–22 / Debrief 12 / closer *The loop half, filled in* 8–10 / Bridge 3). Typical pacing ≈109–110 against the 110-min 2-day slot — zero-buffer tight; the closer's 8-min floor and the author exercise's 18-min floor are the slack. Exercise figures per each exercise file's own Time line. Closer minutes per `lectures/the-loop-half-filled.md` maintainer Time line. Trainer demos slowly, room copy-pastes concurrently — fits 2h00 in-class. Self-study follow-along runs comparably.
