...
**Key sources:** Darragh Curran (CTO), *"2× – nine months later: We did it. You can too."* — [ideas.fin.ai/p/2x-nine-months-later](https://ideas.fin.ai/p/2x-nine-months-later) [practitioner direct, vendor venue, 2026-04-16]; Kesha Mykhailov and Niamh Young, *"AI is approving our pull requests: Here's how we made it safe"* — [intercom.com/blog/ai-is-approving-our-pull-requests](https://www.intercom.com/blog/ai-is-approving-our-pull-requests-heres-how-we-made-it-safe/) [practitioner direct, vendor venue, 2026-04-21]; Brian Scanlan, *"Claude Code: Good skills, bad skills"* — [ideas.fin.ai/p/claude-code-good-skills-bad-skills](https://ideas.fin.ai/p/claude-code-good-skills-bad-skills) [practitioner direct, vendor venue, 2026-07-15]; Intercom product announcements; cycle-51 research
...
- **Review is decomposed, not scored once:** specialist agents separately inspect problem definition, diff-to-intent fit, safety, logical correctness, and repo practices, then trace execution paths. Intercom-specific guidance is refined from engineer feedback on whether comments were useful.
- **Authority is bounded by change shape:** the system refuses large or broad PRs; any engineer can request human review; the human shipper still monitors production and owns rollback. Every approval, comment, test result, and merge event is logged. This explains the safety case more than the model choice does.
- **Calibration evidence remains incomplete:** the April 21 report gives the accepted slice's pilot and revert outcomes, but not the full eligibility rules or false-negative rate. Treat this as L2 evidence for a narrow delegation frontier, not proof of semantic correctness.
