...
Pick the feature and let the skill run. Drop your feature after the colon.
...
- judges @64d17eea: writing PASS (verify-refuted), story PASS, technical REVISE (1/2 see instances/ae101--exercise--map-the-access-surface.technical.json), behavior PASS (1 todo see instances/ae101--exercise--map-the-access-surface.behavior.json), pedagogy PASS (drift-recheck), strategy PASS, slides PASS (1 todo see instances/ae101--exercise--map-the-access-surface.slides.json)
