...
- judges @874f921c: writing PASS (1 finding see instances/ae101--lecture--what-packaging-is.writing.json), story PASS, technical PASS (1 finding see instances/ae101--lecture--what-packaging-is.technical.json), behavior PASS, pedagogy PASS, strategy PASS (1 finding see instances/ae101--lecture--what-packaging-is.strategy.json), slides PASS (1 finding see instances/ae101--lecture--what-packaging-is.slides.json)
