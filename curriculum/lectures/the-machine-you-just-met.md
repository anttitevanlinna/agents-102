...
**Quality:** compendium-audited 2026-09-05 (writing@08946dd8 story@08946dd8 technical@08946dd8 behavior@1480362 pedagogy@d065f8bc strategy@08946dd8 slides@08946dd8)
- judges @08946dd8: writing PASS (verify-refuted), story PASS, technical PASS (1 finding see instances/ae101--lecture--the-machine-you-just-met.technical.json), behavior PASS, pedagogy PASS, strategy PASS, slides PASS
...
- owasp-asi08-cascading-failures `[checked:2026-07-29 result:OK due:none]` https://genai.owasp.org/2025/12/09/owasp-top-10-for-agentic-applications-the-benchmark-for-agentic-security-in-the-age-of-autonomous-ai/ — [academic/research] durable (§2a document identity): the 9 Dec 2025 Top-10's ASI08 naming plus the arXiv title carrying "error cascade" — term coinage is a completed event, not a currency claim. OWASP Top 10 for Agentic Applications (9 Dec 2025) names **ASI08 Cascading Failures** — faults propagating across agents, tools and workflows into system-wide impact. Body says **error cascade**, the literature's term: *"From Spark to Fire: Modeling and Mitigating Error Cascades in LLM-Based Multi-Agent Collaboration"* (arXiv 2603.04474, Mar 2026) carries it in the title. **"Cascading error" is not a term of art** — a student who greps it lands nowhere; do not use it. fallback: OWASP's "cascading failure" is the other legal form; "failure" shifts the sense toward system-wide impact and away from the accumulating-wrongness the slide teaches, so prefer the cascade noun.
