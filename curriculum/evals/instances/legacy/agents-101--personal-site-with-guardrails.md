# Eval Instance — Agents 101 / Personal site with guardrails exercise

Filled-in instance of `curriculum/evals/exercise.md` for the Module 1 (Getting Going) exercise in the Agents 101 training.
...
Enables these LOs from `trainings/agents-101/getting-going.md`:
