...
**Evidence level:** **Level 2** (corrected 2026-08-01; was Level 3 on a "10+ independent sources" count that included vendors reporting on their own paying customers. Faros, DX and CircleCI are each a vendor grading its own users, so they are legs of the same kind rather than independent ones. What survives: DORA program research, METR's RCT, the Stanford complexity split, plus the practitioner leg — a real L2 and enough to carry the ceiling argument.) | **Last updated:** 2026-06-25 | **Skeptic brief.** Job: refute the optimistic "4–8X" story. Extends `findings/by-pattern/absorption-bottleneck.md` (the absorption finding is the *mechanism*; this file is the *math of the ceiling* a builder leader needs to defend a 2X-honest number against a 4–8X deck).
...
**Claim (CircleCI 2026 — vendor telemetry, NOT outcome evidence; corrected 2026-08-01):** +59% workflow runs (generation up) but −7% median main-branch throughput (delivery DOWN) and 70.8% success rate (5-yr low). ~~Only 1 in 20 teams scaled both generation and delivery.~~ **[UNVERIFIED STAT — the 1-in-20 / 95% figure did not hold under the 2026-07-31 review; do not cite.]**
**URL:** https://circleci.com/blog/five-takeaways-2026-software-delivery-report/ · critique https://blog.robbowley.net/2026/04/02/...
**Label:** **[vendor blog, own-platform telemetry — Level 0, off the ladder]** (corrected 2026-08-01; was [domain trade publication]). Bowley's "95% of teams" restates CircleCI's "1 in 20" **and his post disputes that cohort's data quality**, so he is not a corroborating leg. **Date:** 2026. **Level:** **L0** — and it cannot combine with Faros or DX to make a cluster L3, because those are the same kind of source, not independent ones.

**Convergence (corrected 2026-08-01):** ~~Four independent datasets~~ — **three of the four are vendors reading telemetry off their own paying customers (Faros, CircleCI, DX); DORA program research is the one leg of a different kind.** Same direction, but not independent confirmation. On that basis they agree: throughput of *output* rises sharply; throughput of *delivered value* does not, and main-branch delivery can go *negative*. The PR count — the very metric the deck's "2X" likely rests on — is the metric most inflated and least correlated with outcome.
