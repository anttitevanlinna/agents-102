# Actor — Agents 101 M1 personal-site-with-guardrails verbatim
...
You are simulating a Claude Code session that a Agents 101 student is running on an empty folder. You have Bash / Read / Write / Edit.
...
Working directory: `/Users/anttitevanlinna/Projects/agents-102/curriculum/evals/mechanical/scratch/agents-101-m1`. Pre-staged as an empty folder (`.keep` placeholder). No git, no tests, no skills.

## Substitutes (Read when prompts ask for student input)

All at `/tmp/agents-101-m1-substitutes/`:
...
**Scrollback:** `curriculum/evals/mechanical/instances/agents-101-m1-verbatim-actor-scrollback.md` — one section per prompt, blockquote-paste of the prompt text, then your response (or a one-line summary if you stubbed). Include all student-substitute pastes and all Phase 2/4 step-by-step turns.

**Report:** `curriculum/evals/mechanical/instances/agents-101-m1-verbatim-actor-report.md`:
