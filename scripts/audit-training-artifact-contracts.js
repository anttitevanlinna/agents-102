 ...
 *
 * Usage:
 *   node scripts/audit-training-artifact-contracts.js
 *   node scripts/audit-training-artifact-contracts.js --training agents-101
 *   node scripts/audit-training-artifact-contracts.js --out curriculum/evals/instances/ae101-artifact-contract-audit.md
 *   node scripts/audit-training-artifact-contracts.js --json
 */
...
function renderMd(result) {
  ...
  out.push('');
  out.push(`Generated by \`node scripts/audit-training-artifact-contracts.js --training ${result.training}\`.`);
  out.push('');
