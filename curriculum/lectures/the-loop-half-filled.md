...
**Frameworks riffed on:** double-loop learning — Chris Argyris `[cultural-vocab]` (name stays maintainer-side; M3's student-side attribution budget is spent in `skills-from-the-frontier.md`, per `check_writing.md` #11); closed-loop controller = control-theory commons, un-attributed by design; compound ladder + name-the-uncertainty governor = house/groundwork frames. Borrow-tag canon: `theory-plan.md` § The pieces.
