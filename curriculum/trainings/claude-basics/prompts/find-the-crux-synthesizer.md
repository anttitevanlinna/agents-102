...
Two plain prompts for Module 3 of Claude Basics. The first is the core group-synthesis prompt. The second is optional cross-pollination, used only after every group has saved a synthesis file.
