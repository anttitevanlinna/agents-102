...
This is crucially the step that changes how the run behaves.
...
Treat this as a ritual you repeat at the start of every session.
...
At this point the student should notice the test is still red.
...
There is no penalty if you skip this, and it is completely fine either way.
...
This section previously said something different; it was fixed on 2026-01-14.
