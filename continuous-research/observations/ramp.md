...
> **Second Ramp source, uncited here and owed a pass.** Levick's post (linked above) appears to be the origin of several figures in the Scale Claims table below, and one figure diverges — a 99.7% team-active number is associated with Levick against this file's 99.5%. Neither Levick's post nor the divergence has been read first-hand by this file; do not reconcile them by guessing which is right. `[checked:never result:NEEDED due:asap]`
