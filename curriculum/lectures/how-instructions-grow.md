...
**Quality:** compendium-audited 2026-09-06 (writing@08946dd8 story@324b81d7 technical@08946dd8 behavior@64d17eea pedagogy@a1ddfae2 strategy@08946dd8 slides@c0c37913)
- judges @64d17eea: writing PASS (2 findings see instances/ae101--lecture--how-instructions-grow.writing.json), story PASS, technical PASS, behavior PASS, pedagogy PASS, strategy PASS, slides PASS (1 finding see instances/ae101--lecture--how-instructions-grow.slides.json)

**Lecture meta:** *M2 closing lecture, after the save-if-earned rule integration and before Key Concepts. Slide order: route, second loop, ceiling, taste, keep-where-it-loads. Route slide: one common evidence-to-rule-to-skill route, refusing a universal promotion ladder. Second-loop slide: Argyris's distinction through the context mechanism the student has used. Ceiling slide (Antti-directed 2026-08-19; third paragraph 2026-08-23): symptoms are context bloat and hard-to-pin degradation, cure is lean CLAUDE files plus on-demand skills, plus a prune clause and a declared stop; the full context-lifecycle system is beyond this training and the team's to automate; the training knowingly teaches toward a CLAUDE-file ceiling and declares the scaffold rather than hiding it; closing sentence is Antti's wording, keep. Taste slide (Antti-directed 2026-08-19): prohibitions stop behaviour without teaching the replacement (the child analogy is Antti's, keep it); taste with the why is shorter than the no-statement cage and generalizes past it; good runs earn rules too. Closing slide *Keep your context where it loads optimally* (Antti-directed 2026-08-23; last, so the live return is the final thing seen and the supplement link rides it): the compound/integrate prompts generalise to every context file, moving material between files is a Claude ask, `ae101-m2-name-what-moves` names what would move. Trainer runs the prompt on the demo repo and reads the return aloud (`check_lectures.md` §6); "none" is a fine return, the shape is the lesson. Students may run it on their own files, offer grammar. Naming only, nothing written, no artefact contract. Number-free and vision-grade; deep treatment in `supplementary/the-context-ceiling.md`, linked from the final slide (Antti-directed 2026-08-19, deliberate exception to supplements-link-from-modules: the link rides the slide so Key Concepts stays standard; AE101-only, so the training-specific path does not break shared-library re-placement). Mood: grounded competence; the student leaves able to place the artifacts without being told every artifact must move.*

**Time:** 7 minutes, two of them the closing slide's live prompt run.
