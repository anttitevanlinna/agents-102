# Eval Instance — Bootstrap / Hallucination bake-off exercise

Filled-in instance of `curriculum/evals/exercise.md` for the Module 5 (Output Quality and Hallucination Control) exercise in the Bootstrap training.

**Target exercise file:** `curriculum/exercises/hallucination-bakeoff.md`
**Module file:** `curriculum/trainings/bootstrap/output-quality.md`
