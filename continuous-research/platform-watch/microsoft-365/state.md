...
- **Cowork now in Frontier program (March 30). First named enterprise deployments — vendor-cited.** Capital Group (planning, scheduling, deliverables, executive review prep) and Coca-Cola Beverages Africa ("1-1.5 hours per planner daily" savings) cited by Microsoft. Vendor-sourced only — no independent verification. If confirmable independently, these break the Cowork zero streak. Watch for third-party mentions post-TDX/Cloud Next. ([Microsoft blog](https://www.microsoft.com/en-us/microsoft-365/blog/2026/03/30/copilot-cowork-now-available-in-frontier/), Mar 30, 2026) — [vendor press release]
- **Copilot Researcher "Critique Mode" feature update (April 2, 2026).** Adds reflection loop to Researcher agent. Feature announcement only; no deployment evidence. ([Dataconomy](https://dataconomy.com/2026/04/02/microsoft-upgrades-365-copilot-researcher-with-new-critique-mode/), Apr 2, 2026) — [general press]
- **Cowork silence: 35th consecutive zero (cycle 69, March 24), now partially broken by Frontier program access.** 15+ days post-announcement, zero independent reviews. Analysis-of-announcement pieces exist (FindSkill, Aideate, Tech Insights) but zero hands-on user reports. We are now IN the "late March" broader Frontier access window — zero evidence of delivery. No YouTube demos, no Reddit threads, no blog posts from independent users. Mollick (Wharton): "cannot figure out any way to trigger GPT-5 Thinking Extended/Claude 4.5 Sonnet level responses — no deep thinking, no agentic actions, no document outputs." Also noted Anthropic's Cowork "was built in a couple of weeks using Claude Code and is being updated and evolving quickly" — questioning Microsoft's iteration speed. Teamblind insider: "we are cooked at Microsoft" citing stack rank culture and brain drain. Gartner: Cowork "does not support local computer use, cannot interact directly with local files or applications, and lacks native integrations with third-party tools." ([Mollick on X.com](https://x.com/emollick/status/1983962613576036736); [Teamblind](https://www.teamblind.com/post/how-did-microsoft-fumble-copilot-so-bad-when-claude-cowork-exists-kiishvku), Mar 2026)
...
- **Cycle 33 update (March 22):** Still zero independent reviews — 13+ days post-announcement. Critically: other Frontier features ARE shipping on schedule (Copilot Notebooks rolling out March 23-28, Planner Agent mid-March through late April) while Cowork has no confirmed rollout date. This makes the absence more conspicuous — it's not that Frontier is delayed, it's that Cowork specifically is not shipping. [The Deep View](https://www.thedeepview.com/articles/microsoft-debuts-cowork-agent-but-has-work-to-do) framed Cowork as aspirational: "Microsoft has been having trouble competing" and "without developing its own models... catching up could be difficult." If March ends without broader Frontier access, Microsoft missed its own commitment. (source: runs/2026-03-22-cycle33.md)
- **Cycle 36 update (March 22):** 14+ days, zero independent reviews across 5 consecutive research cycles. Other Frontier features shipping on schedule (Notebooks, Planner Agent) — Cowork is the specific exception. **Ben Thompson (Stratechery, March 10):** Cowork proves model-agnosticism is dead for agentic work — compelling agentic products require model + harness as integrated pieces. Microsoft must partner with Anthropic for the capability it's selling as its future. ([Stratechery](https://stratechery.com/2026/copilot-cowork-anthropics-integration-microsofts-new-bundle/), practitioner analysis). Microsoft leadership reshuffle March 17 (Roslansky, Clarke, Lamanna) happened 8 days after Cowork announcement. Cowork silence now confirmed structural, not early. (source: runs/2026-03-22-cycle36.md)
- **Cycle 93 update (April 8, 2026) — Frontier program active, silence partially broken, GA May 1 confirmed:**
  - Cowork now in Frontier program (March 30). GA as part of M365 E7 Frontier Suite scheduled **May 1, 2026**.
  - **Capital Group** (SVP Barton Warner, vendor-cited): planning, scheduling, deliverables, executive review prep. Quote: "take real action, connecting steps, coordinating tasks...within our security and risk boundaries." — [vendor press release, Level 0]
  - **Coca-Cola Beverages Africa**: "1-1.5 hours per planner daily" savings claimed — [vendor press release, Level 0]
  - **Futurum Group analyst review (Keith Kirkpatrick):** Found "proof point does not yet exist at scale." Accountability gap: "When an AI agent contributes to a shared document or a group decision in real time, who owns the output?" Permissions model not yet published. Forward-looking speculation, not deployment evidence. ([Futurum Group](https://futurumgroup.com/insights/will-ms-copilot-cowork-enable-real-enterprise-ai-collaboration/), analyst commentary, Mar/Apr 2026) — [analyst, Level 0]
  - **Winbuzzer technical article (Mar 31, 2026):** Describes Critique feature (GPT drafts, Claude independently reviews for accuracy before delivery). DRACO benchmark 57.4 — 13.8% improvement. **No independent verification.** — [general press, bare facts only]
  ...
  - **Cycle 94 update (April 9, 2026) — Cowork silence fully broken: two independent practitioner reviews now exist:**
    ...
    - **Cycle 96 update (April 11, 2026) — EU Flex Routing: new compliance risk for ALL Nordic Copilot customers:** Microsoft introduced Flex Routing (MC1269223) — when EU infrastructure is at peak demand, Copilot LLM inferencing may route to US/Canada/Australia. Opt-out review deadline: **April 17, 2026** (before default activation). GDPR implications: personal data processing may temporarily occur outside EU. Limited pseudonymised data may also be stored outside for operational security. Data at rest stays in EU; inference moves out under load. Confirmed: Cowork still excluded from EU Data Boundary (unchanged). The Flex Routing issue applies to standard Copilot across all M365 plans in EU tenants — not just Cowork. ([office365itpros.com](https://office365itpros.com/2026/04/07/flex-routing-copilot-europe/), Apr 7, 2026 — [domain trade publication, Level 3]; [changepilot.cloud](https://changepilot.cloud/blog/microsoft-365-copilot-flex-routing-eu-data-boundary-mc1269223)) **ACTIONABLE FOR NORDIC COMPLIANCE LEADS: Review Flex Routing setting before April 17.**
...
- **Post-GA reliability approaching convergence (cycle 33):** 5+ independent practitioners report: tools fail randomly with identical parameters (planner selects but executor fails), hard limit of 5 nested tool calls (not configurable), agent identity bug (published agents use shared project identity, [GitHub #93](https://github.com/microsoft-foundry/new-foundry-portal/issues/93)), Teams publishing broken with 400 errors when Knowledge enabled ([GitHub #277](https://github.com/orgs/microsoft-foundry/discussions/277)), Code Interpreter containers failing in EastUS2 since Feb 21, built-in grounding "NOT ENFORCED" ([Juliansmiles Medium](https://medium.com/@juliansmiles_40140/azure-ai-foundry-agent-service-technical-limitations-6b0f00ff4adc), Jan-Mar 2026, practitioner direct). At day 6 post-GA, practitioner signals are overwhelmingly bug reports, not success stories.
...
| Entra Shadow AI Detection? | **GA (shipped at RSAC 2026, March 20 — ahead of March 31 deadline).** Network-layer detection of unknown AI apps via Entra Internet Access. Also GA: prompt injection protection, Security Dashboard for AI, synced passkeys. Part of Agent 365 + E7 positioning. | [MS Security Blog](https://www.microsoft.com/en-us/security/blog/2026/03/20/secure-agentic-ai-end-to-end/); [MS Entra Blog](https://techcommunity.microsoft.com/blog/microsoft-entra-blog/microsoft-entra-innovations-announced-at-rsac-2026/4502146), Mar 2026 |
| CVE-2026-26144 Excel Copilot exfiltration? | **Patched March 10.** CVSS 7.5. Zero-click data exfiltration — XSS in Excel web-rendering triggers Copilot Agent to make outbound requests to attacker endpoints. Agent's network privileges become the exfil channel. | [The Register](https://www.theregister.com/2026/03/10/zeroclick_microsoft_info_disclosure_bug/), Mar 2026 |
| CVE-2026-26118 Azure MCP SSRF? | **Patched.** CVSS 8.8. SSRF in Azure MCP Server Tools — attacker steals managed identity token via crafted URL input. Enables lateral movement. Public PoC on GitHub. Affects versions prior to 2.0.0-beta.17. | [TheHackerWire](https://www.thehackerwire.com/azure-mcp-server-ssrf-for-privilege-elevation-cve-2026-26118/); [Blueinfy](https://blog.blueinfy.com/2026/03/ssrf-in-azure-mcp-server-tools.html), Mar 2026 |
| Copilot DLP sensitivity label bypass? | **Second time in 8 months.** Copilot ignored sensitivity labels twice, no DLP stack caught either incident. Undermines E7 enterprise security positioning. | [VentureBeat](https://venturebeat.com/security/microsoft-copilot-ignoring-sensitivity-labels-dlp-cant-stop-ai-trust-failures), Mar 2026 |
...
| Copilot Cowork (personal agent) | Research Preview | Zero user reports (14+ days, 5 cycles). Silence structural. |
| Pre-built business agents | Shipping (Dynamics 365 only) | No independent production reports |
| Foundry Agent Service | **GA (March 16)** | Private networking, multi-model, evals. Corvus Energy named (no metrics). One week post-GA: zero new deployments, pre-GA bugs persist. |
...
### From cycle 33 (Cowork rollout status, security CVE cascade, Nordic AI value gap):
- **Copilot Cowork: inside "late March" window, still zero reviews.** 13+ days post-announcement. Other Frontier features shipping on schedule (Notebooks March 23-28, Planner Agent mid-March). Cowork has no confirmed rollout date. The Deep View skeptical: "Microsoft has been having trouble competing." If March ends without broader Frontier access, Microsoft missed its own commitment. (source: runs/2026-03-22-cycle33.md)
- **Security CVE cascade: 3 vulnerabilities in one month.** CVE-2026-26144 (Excel Copilot zero-click exfil, CVSS 7.5), CVE-2026-26118 (Azure MCP Server SSRF, CVSS 8.8, public PoC), plus DLP sensitivity label bypass (second time in 8 months). Pattern: AI agent integration features create new attack surfaces. MCP protocol infrastructure itself is an attack vector. Microsoft simultaneously creating the risk and selling the solution. ([The Register](https://www.theregister.com/2026/03/10/zeroclick_microsoft_info_disclosure_bug/); [TheHackerWire](https://www.thehackerwire.com/azure-mcp-server-ssrf-for-privilege-elevation-cve-2026-26118/); [VentureBeat](https://venturebeat.com/security/microsoft-copilot-ignoring-sensitivity-labels-dlp-cant-stop-ai-trust-failures), Mar 2026)
- **Foundry reliability approaching convergence.** 5+ independent practitioners reporting post-GA issues: non-deterministic tool invocation, agent identity bugs, Teams publishing failures, Code Interpreter failures, grounding not enforced. At day 6 post-GA, signals are overwhelmingly bug reports, not success stories. ([Medium](https://medium.com/@juliansmiles_40140/azure-ai-foundry-agent-service-technical-limitations-6b0f00ff4adc); [GitHub #93](https://github.com/microsoft-foundry/new-foundry-portal/issues/93); [GitHub #277](https://github.com/orgs/microsoft-foundry/discussions/277), Jan-Mar 2026)
- **BCG: Only 4% of Nordic companies achieve strong AI returns.** 54% experimenting with agents, 24% observing. ~60% allocate <5% of AI budget to agentic initiatives. Core problem: over-investment in off-the-shelf tools, under-investment in transformative workflow redesign. Risk of "AI value bubble." ([BCG](https://www.bcg.com/publications/2026/nordic-ai-value-creation-or-bubble), 2026)
- **Ramp March 2026: Anthropic captures 73% of new enterprise AI buyers.** Up from 50/50 ten weeks ago. OpenAI had its largest single-month adoption decline ever. Multi-vendor is the norm (79% of Anthropic customers also pay for OpenAI). ([Ramp](https://ramp.com/velocity/ai-index-march-2026); [Axios](https://www.axios.com/2026/03/18/ai-enterprise-revenue-anthropic-openai), Mar 2026)
...
- **Entra Shadow AI Detection shipped ahead of schedule (GA at RSAC, March 20).** Also GA: prompt injection protection, Security Dashboard for AI. Governance infrastructure continues to outpace agent deployment — consistent pattern. ([MS Security Blog](https://www.microsoft.com/en-us/security/blog/2026/03/20/secure-agentic-ai-end-to-end/); [MS Entra Blog](https://techcommunity.microsoft.com/blog/microsoft-entra-blog/microsoft-entra-innovations-announced-at-rsac-2026/4502146), Mar 2026)
- **E7 segmentation challenge flagged.** Directions on Microsoft: knowledge workers (legal, marketing, sales ops, HR) may benefit from $99/user. Light users checking email won't. Not every M365 user needs full stack. ([Directions on Microsoft](https://www.directionsonmicrosoft.com/why-microsoft-365-e7-is-more-than-just-a-new-licensing-tier/), domain trade publication, Mar 2026)
- **Nordic: tenth consecutive zero** for M365 business agent deployments. Consulting ecosystem (EY Norway, Capgemini Norway, Arribatec, Cloudpartner.fi) active in readiness and licensing analysis — zero deployments. Corvus Energy (Foundry, vendor-sourced) remains only Nordic signal.

### From cycle 108b (Agent 365 pre-GA scan, April 23, 2026):
- **Agent 365 GA confirmed May 1, 2026 — $15/user/month standalone.** Included in M365 E7 at $99/user/month. All agents acting on behalf of a licensed user are covered — agents themselves don't need separate licenses. Each agent gets a Microsoft Entra Agent ID with directory identity and lifecycle management, visible in M365 Admin Center. ([Microsoft Community Hub](https://techcommunity.microsoft.com/discussions/agent-365-discussions/agent-365-will-be-generally-available-on-may-1-2026/4500380) — vendor; [SAMexpert](https://samexpert.com/agent-365/) — domain trade publication / licensing specialist)
- **Security posture management NOT GA on May 1 — still preview.** Security posture management for Foundry + Copilot Studio agents + detection and response remain in public preview on GA day. Runtime threat protection via "Agent 365 tools gateway" enters public preview in April — not GA. The governance identity layer ships; the security layer does not. ([M365 Admin](https://m365admin.handsontek.net/microsoft-agent-365-generally-available-may-1-2026/) — domain trade publication)
...
- `2026-03-22-cycle33.md` — Cowork inside late-March window still zero, security CVE cascade (3 in one month), Foundry reliability approaching convergence, BCG Nordic 4% strong returns, Ramp Anthropic 73% new buyers, ninth Nordic zero
- `2026-03-22-cycle36.md` — Cowork structural silence (14+ days, 5 cycles, Thompson model-agnosticism analysis), Foundry one week post-GA zero new deployments + bugs persist, Entra Shadow AI Detection GA early, E7 segmentation challenge, tenth Nordic zero
