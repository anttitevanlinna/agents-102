...
- judges @324b81d7: writing PASS (3 todos see instances/ae101--module--getting-going.writing.json), story PASS (1 todo see instances/ae101--module--getting-going.story.json), technical PASS (1 todo see instances/ae101--module--getting-going.technical.json), behavior PASS, pedagogy PASS, strategy PASS, slides PASS (1 todo see instances/ae101--module--getting-going.slides.json)
