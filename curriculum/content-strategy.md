...
Prework (as of 2026-04-20): **Three-walls pre-read** bundling **data access, runtime, discoverability** — the three walls practitioners hit in their first week of trying to share their work, F-Secure-validated across two cohorts. Plus **absorption bottleneck** (L4) and **Access-Trust Gap** (Pattern 47, L4) as the strategic layer on top — explaining why walls stall rollouts even when addressed, why access doesn't convert to trust, why learning rate caps capability adoption. The announcement-to-deployment gap (Pattern 31) moved OUT of this bundle on 2026-04-20 — it's a research/media pattern for reading vendor noise, not a wall practitioners hit inside their own rollout. Plus Rumelt on *crux / Good Strategy Bad Strategy*, Roger Martin on *strategy as assumptions / what would have to be true?*, Gary Klein on *pre-mortem* (migrated from M8 — the strategy skills are now M7 material). The 8 practitioner stories originally TODO'd are superseded by the patterns catalog (`strategy/personal-to-team-patterns.md`) which students consult live during the exercise.
