...
M6 rung: none, the rate bullet is declined (Antti 2026-09-02, read against the frame) · M4 disclosure
...
- **25/37 laws already NAMED with mechanism in student body.** "Most theory exists already" — confirmed. 8 confirmed delivery gaps; several are org/CTO-layer laws likely not AE101's to teach (triage table in audit). **Maybes, not todos (Antti, 2026-09-02):** access-trust-gap · competence-first-sequence · pattern-layer-ontology — out of AE101 body; possible later material, homes today groundwork / Agents 101. **M6 maybes (from the 2026-08-28 loop-architecture reframe note, branch `claude/module-six-quality-feedback-ochsnc`, otherwise superseded by the 2026-09-02 three-beat re-cut and the expression frame in the strategy doc § M6):** feedback sources plural — the engineer owns CI history, review latency, incidents, their own scrollback push-backs, and reads none of them back; check latency + placement as a design axis (how fast a check can say no, where it sits relative to the producer). Neither is in AE101 body; both are M6-or-later material. **Eval is taught, not experienced (2026-09-02):** the M6 *Eval* slide defines an eval as a measurement across runs, and the room has measured nothing that day (they diffed two sessions and cut a rule); the slide leans on the M5 verifier for its instruments. No cheap fix inside 120 min; a candidate is a pass-rate read across the M4/M5 pair in the diff prompt. Maybe, not a todo.
