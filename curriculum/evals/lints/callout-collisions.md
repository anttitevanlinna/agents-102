...
**Catches:** the same `bosser-strategy:philosophy.md` belief number quoted across adjacent lectures in a session, or quoted more than once in a single lecture without deliberate build-up.
...
- Find every explicit reference to a philosophy belief (e.g., "belief #7," or quoted lines matching `bosser-strategy:philosophy.md`)
- Report:
