...
Validation for multi-hour agent runs groups into three categories. Use these as the answer shape:
...
Don't name frameworks or practitioners by label. Walk from the specific failure to the specific validation.
