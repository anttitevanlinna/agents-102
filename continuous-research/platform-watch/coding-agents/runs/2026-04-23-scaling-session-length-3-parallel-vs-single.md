...
- **Spotify Honk (Nov 2025 → Apr 2026):** 1,500+ PRs in part 1 (Nov 2025), 650+/month at steady state, 1,000 PRs in 10 days at current rate [all numbers self-reported by Spotify, no independent verification]. Sits on Fleet Management infra (since 2022). The standalone Spotify Engineering posts (Nov/Dec 2025) are the load-bearing source [practitioner direct, vendor surface — Spotify writing about own internal use]: https://engineering.atspotify.com/2025/11/spotifys-background-coding-agent-part-1 ; https://engineering.atspotify.com/2025/12/feedback-loops-background-coding-agents-part-3 . The Apr 2026 piece is co-published with Anthropic [practitioner direct, co-marketing — treat numbers as self-reported] https://engineering.atspotify.com/2026/4/anthropic-agentic-development
...
- **Anthropic / Carlini (Feb 2026):** 16 parallel Claude Opus 4.6 instances, 2 weeks, ~2,000 sessions, $20K, 100K-line C compiler. Internal proof-of-concept that agent-team coordination scales. [practitioner direct, vendor surface — Anthropic engineer writing on anthropic.com about internal Claude use; treat numbers as self-reported] https://www.anthropic.com/engineering/building-c-compiler
...
- **3–5 parallel is the practical ceiling for most.** Directional claim repeated across worktree-tooling discussions, but no single named-practitioner URL backs the specific 3–5 number. [SOURCE NEEDED — find a named practitioner who publishes the ceiling] — Karpathy's 10–20 and Cursor's hundreds are outliers running on dedicated harness infra, not a vanilla terminal setup.
...
- **Parallel fanout with file-based handoff: L2 climbing toward L3.** Independent practitioner count, strict tally: 5 (Spotify, Ramp, Cursor/Wilson Lin, Karpathy, Sanity/Quigley). Anthropic/Carlini sits on a vendor surface (anthropic.com) and Imbue is a vendor product release — both excluded from the practitioner count per the evidence ladder. Well below the 10–20 floor for L3, and tools/worktree ecosystem don't count toward the practitioner tally. Same substrate and same diagnosis (markdown beats shared scrollback) across all 5, so the *direction* is clear; promote to L3 once 5+ more independent named practitioners publish the same pattern.
