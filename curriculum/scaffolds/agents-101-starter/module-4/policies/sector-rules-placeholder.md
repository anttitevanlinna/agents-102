...
This file is a **placeholder** in the Nordic-baseline policy reference set. In-company deliveries replace this file with actual sector rules from the buying organisation, co-created as a separate deliverable outside this repository.
