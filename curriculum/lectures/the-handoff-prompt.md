...
**Body line *"What comes back is a prompt, not a plan. Save it where you will find it."* stays as it is (Antti 2026-09-03).** Neither the plan-instead-of-prompt tell nor the reviews-instead-of-checks tell goes into the body: more text without value at a three-minute beat. Recovery stays trainer-side, in the note above. Judges should not re-file `check_pedagogy.md` §47, `check_student_facing.md` §5 or §9 on that line.
