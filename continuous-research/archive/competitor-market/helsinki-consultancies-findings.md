# Helsinki Consultancies — Findings & Orientation Log
...
Searched: "Futurice Reaktor Helsinki consultancy AI agents offerings 2025 2026" and "Futurice Vincit Siili Columbia Road Finnish digital consultancy AI services training 2025 2026." Cataloged 8 firms across the Helsinki/Finnish digital consultancy ecosystem: Reaktor, Futurice, Columbia Road, Siili Solutions, Vincit, Gofore, Eficode, and VML Finland.

Key data points found:
- Reaktor has the most visible AI positioning: a dedicated Data & AI practice, VP-level AI leadership, and a joint GenAI research project with University of Helsinki involving multiple Finnish corporates. They also co-created Elements of AI (1M+ global enrollments) — but that is an intro awareness course from 2018, not a capability-building program.
- Siili Solutions brands itself as "AI-driven digital development" and has AI embedded across its delivery model.
- Eficode runs a commercial training business (DevOps, Atlassian, Kubernetes) — the only firm in this set with established training product mechanics.
- No firm in this set has any publicly visible agentic AI offering, training program, or network/curation model.

### Orient

**The core finding: Helsinki consultancies are not in the AI training or agentic AI space. They are in the bespoke consulting space.**

This entire cohort of firms operates on the same fundamental model: sell talented people doing custom work for enterprise clients. Whether it is Reaktor (strategy + engineering), Futurice (design + transformation), Siili (AI-driven development), or Gofore (public sector digital), the revenue comes from project-based or capacity-based consulting engagements. None of them sells scalable programs, curated practice libraries, or network-based knowledge products.
...
4. **Culture and identity mismatch.** These firms identify as "we solve your unique problem" — not as "we teach you to solve it yourself and connect you with peers." The consulting identity is deeply embedded. Pivoting to a training/network model would require a philosophical shift that most consulting partners would resist. "Why would we teach our clients to do what we charge them for?"
...
3. **Elements of AI redux.** Reaktor demonstrated with Elements of AI that they can create massive-reach educational products when motivated. If Reaktor decided to create "Elements of Agentic AI" with the University of Helsinki, it would have instant credibility, university backing, and Reaktor's brand. This is the highest-risk scenario — but it is unlikely in the near term because (a) Reaktor has no commercial incentive to build a free course again, and (b) their current GenAI research project is academic, not educational.

**Structural limitation shared by all these firms:**

They are consulting businesses. Their entire economic engine — incentives, talent model, client relationships, pricing, partner compensation — is built around selling bespoke expert time. Building a scalable training/network product is a fundamentally different business. It requires different unit economics, different talent (facilitators and curators, not senior consultants), different sales motions (program sales, not project sales), and different success metrics (network growth, not utilization rate). Consultancies talk about "productizing" their knowledge, but almost none actually do it at scale, because the consulting model is too profitable and too familiar to abandon.
...
| Curated best-in-class practices | No curation function. Knowledge stays inside projects. |
| Vendor-agnostic, principle-first | They are vendor-agnostic in delivery, but do not teach principles — they apply them for the client. |
| Non-coder audience | Their client contacts are often executives and managers, but they serve them with consulting, not with training. |
| Agentic AI focus | No visible agentic AI positioning at any firm. |

### Decide

**Do we need another round?**

Maybe, but not urgently. The Finnish consultancy landscape is well-mapped for competitive purposes. The finding is clear: these firms are not in our space and are unlikely to enter it soon.

**What a Round 2 could investigate:**

1. **Nordic (non-Finnish) consultancies** — are firms like Netlight (Sweden), Computas (Norway), or Knowit (pan-Nordic) doing anything different in AI training or agentic AI? The competitive frame might be Nordic, not just Finnish.
...
Searched: "Aalto EE executive education AI training Hanken SSE executive education Nordic Business Forum Finland corporate training 2025 2026" and "Solita Finland AI consultancy agentic AI Renessai AI company Finland offerings training 2025 2026." Cataloged 5 additional entities in two categories: (A) Finnish corporate training buyers — Aalto EE, Hanken & SSE Executive Education, Nordic Business Forum; (B) Flagged firms — Solita, Renessai.
...
2. **Consultancies are the second call.** When the ask is "help us deploy AI" (not "train our people on AI"), the buyer calls Solita, Reaktor, or Futurice. These firms absorb demand through consulting-embedded training — building alongside the client, with knowledge transfer as a side effect. Solita is the strongest player here, with the deepest AI expertise and the only visible agentic AI positioning.

3. **Everything else is niche.** Hanken & SSE for Swedish-speaking/Nordic finance circles. NBF for event-based inspiration. Renessai for boutique strategic AI advice. None of these are primary competitors or channels.

**Does this change the competitive picture from Round 1?**
...
Not urgently for the Finnish landscape. The buyer map is now clear: Aalto EE owns the relationship, Solita is the embedded threat, everything else is secondary.
...
Two files updated:
- `research/helsinki-consultancies-resources.md` — Appended 5 new firm entries (Aalto EE, Hanken & SSE, Nordic Business Forum, Solita, Renessai) with Round 2 summary table.
- `research/helsinki-consultancies-findings.md` — Appended this Round 2 orientation with buyer landscape analysis, updated threat assessment, channel partner evaluation, and decision on next steps.
