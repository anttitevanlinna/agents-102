# Eval Instance — Agents 101 / Evaluations module

Filled-in instance of `curriculum/evals/lecture.md` for the Module 6 (Evaluations) lecture in the Agents 101 training.
...
The piece equips the reader to achieve these Bloom-tagged learning goals (from `trainings/agents-101/evaluations.md`):
