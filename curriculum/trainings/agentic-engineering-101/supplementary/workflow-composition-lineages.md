...
**Quality:** draft 2026-05-21 (rewritten 2026-05-21 after Cycle 3 confirmation + Antti fact-check; supersedes the 2026-05-20 draft. Five practitioner-grounded shapes plus counter-position; field-totality claims dropped; quote attributions verified against direct sources where possible.)

**Supplementary meta:** *Reading material for AE101 M6 practitioner-mode beat. Pairs with `lectures/composing-the-workflow.md`. Six sections: one named framework (Klaassen), four shapes (Pocock / Yan-Cognition / Metcalf-Amp / Cherny-moves), one counter-position (Ronacher). Closes with three filters for picking what to study first. Explicit scope note in intro: the walk is partial, the field has more named frameworks than this set surfaces, the curation reflects what AE101's OODA cycles caught.*
...
- **Lecture-side reframe.** `lectures/composing-the-workflow.md` body says *"At least five live lineages, each disagreeing with the others on load-bearing details"*. After the 2026-05-21 rewrite the supplementary describes five shapes + one counter-position, with one being a named framework and the rest being stances / methodologies / move-catalogues. The lecture body should be reread for alignment with the supplementary's tightened framing before first cohort.
