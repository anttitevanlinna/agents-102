...
## Salesforce Agentforce: Real but Polarizing

Agentforce continues to be the most deployed enterprise agent platform. Key March 2026 data:

### Production Agentic (Level 2)
...
- "We replaced a working interface in a B2B portal with an agent that can look up orders" — called "a solution looking for a problem"
...
- Source: https://www.oliv.ai/blog/salesforce-agentforce-reviews-analyzed [practitioner analysis]

**Revised assessment:** Agentforce remains "real but narrow" (confirming February finding). The polarization is the story — some implementations work well (Williams-Sonoma), many feel forced. The Data Cloud requirement is a significant adoption barrier not previously tracked.

---

## ServiceNow: Major Move with Autonomous Workforce
...
**Assessment:** The 90% autonomous IT resolution (internally) is a strong signal IF independently verified. The "Autonomous Workforce" framing is aggressive — moving beyond agents to "AI specialists with roles." This aligns with our convergence pattern #3 (narrow specialization). However, the naming ("replaces people") risks the Klarna-style backlash.

**Evidence level:** Level 1-2. ServiceNow's own claim is Level 0. VentureBeat and diginomica coverage adds credibility but no independent customer deployment data found yet. **Watch this space — customer evidence expected Q2 2026.**

**Finding category:** Platform Announcement with strong vendor evidence. Not yet independently verified as Production Agentic.

---

## Microsoft Dynamics 365: Release Wave 1 (April 2026)

**2026 Release Wave 1** published March 18, 2026 — new capabilities rolling out April–September 2026:
- Agent Mode across Word, Excel, PowerPoint (shift from assistant to autonomous)
...
- Source: https://m365admin.handsontek.net/dynamics-365-power-platform-role-based-copilot-offerings-2026-release-wave-1-plans-available-now-2/ [domain trade publication]

**Assessment:** Microsoft's approach is the most pervasive — agents embedded in tools everyone already uses (Office, Excel, Dynamics). The "straight to GA, no Early Access" approach means Nordic enterprises running M365 will get agent capabilities in April 2026 whether they're ready or not. This reinforces finding #4 from our map: "Agents arriving in your software whether you plan for it or not."

**Finding category:** Platform Announcement (capabilities not yet GA, rolling out April 2026).
...
| ServiceNow | Moveworks acquired | Autonomous Workforce launched. Bold framing. No customer evidence yet. | ↑ (significant announcement) |
| Microsoft D365/Copilot | Account Reconciliation Agent | Release Wave 1 shipping April 2026. Agent Mode in Office. | ↑ (imminent GA) |
