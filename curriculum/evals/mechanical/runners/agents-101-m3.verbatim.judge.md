# Judge — Agents 101 M3 three-retrievers-one-curator verbatim
...
- **Scratch:** `/Users/anttitevanlinna/Projects/agents-102/curriculum/evals/mechanical/scratch/agents-101-m3`
...
- **A8.** Synthesizer did NOT Read mock-library files. `jq` for any `/tmp/agents-101-mocks/` Read.
...
Write `curriculum/evals/mechanical/instances/agents-101-m3-verbatim-judge-report.md`:

```markdown
# Judge report — Agents 101 M3 verbatim
