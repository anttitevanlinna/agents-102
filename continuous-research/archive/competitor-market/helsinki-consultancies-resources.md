# Helsinki Consultancies — Firm Catalog

**Track**: Helsinki/Finnish Mid-to-High-End Consultancies and AI/Agent Offerings
**Round 1** | 2026-02-14

**Sources**: Web searches for "Futurice Reaktor Helsinki consultancy AI agents offerings 2025 2026" and "Futurice Vincit Siili Columbia Road Finnish digital consultancy AI services training 2025 2026"; reaktor.com; futurice.com; company knowledge.
...
- **HQ**: Helsinki, Finland (offices in Amsterdam, New York, Tokyo, Lisbon)
- **Size**: ~750 people (designers, developers, strategists). Private, estimated revenue EUR 100-150M.
- **Overall positioning**: High-end digital consultancy. Strategy, design, custom software, data & AI. Known for technical excellence and culture (flat hierarchy, no middle management). Serves large enterprises and public sector. Premium pricing. Attracts top engineering talent from Aalto University pipeline.
- **AI/ML offerings**: Dedicated Data & AI practice led by VP-level leadership (Marko Aalto). Offers AI strategy, data platform builds, ML model development, and AI solution implementation. Positioned as "turn data ambition into business value." Recent high-profile initiative: joint research project with University of Helsinki on GenAI's impact on software development productivity, with multiple Finnish corporate partners joining.
...
- **HQ**: Helsinki, Finland (offices in Munich, Berlin, London, Stuttgart, Tampere, Stockholm)
- **Size**: ~700 people across the Futurice Group (including Columbia Road and other entities). Private, estimated revenue EUR 80-120M.
- **Overall positioning**: "Digital transformation with measurable outcomes." Design + technology + strategy consultancy. Strong culture-first brand (Futurice Culture Deck is well-known). Serves mid-to-large enterprises across Nordics and DACH region. Known for human-centered design, lean approaches, and "co-creation" with clients. Part of a family of companies including Columbia Road (digital sales) and other subsidiaries.
- **AI/ML offerings**: AI is embedded across their service lines rather than isolated as a dedicated practice. Offerings include AI strategy consulting, AI-powered product/service design, machine learning implementations, and data-driven business models. Positions AI as part of "digital transformation" rather than as a standalone capability.
...
## 3. Columbia Road (Futurice subsidiary)

- **URL**: https://www.columbiaroad.com
- **HQ**: Helsinki (offices in Sweden and Netherlands)
- **Size**: ~100-150 people (part of the Futurice Group's ~700)
- **Overall positioning**: "Nordic digital sales consultancy." Specializes in e-commerce, digital marketing, and data-driven sales. Spun out of Futurice to focus specifically on revenue-generating digital. More commercially oriented than the parent company.
...
- **HQ**: Helsinki, Finland (offices across Finland and internationally)
- **Size**: ~900-1,000 people. Publicly traded on Nasdaq Helsinki. Revenue approx. EUR 100-130M.
- **Overall positioning**: "AI-driven digital development." Serves large enterprises and public sector. Core services: data & AI, custom software development, digital platforms, managed services. Positioned as a long-term technology partner rather than a short-engagement consultancy. More "body shop plus strategy" than pure consulting.
- **AI/ML offerings**: AI is a stated core strength — "AI-driven" is part of the company tagline. Offers data & AI consulting, ML model development, data platform builds, and AI integration into existing systems. AI is embedded throughout their delivery model.
...
- **URL**: https://www.vincit.com
- **HQ**: Tampere, Finland (offices in Helsinki, Turku, Oulu; US operations in California)
- **Size**: ~500-600 people. Publicly traded on Nasdaq Helsinki. Revenue approx. EUR 60-80M.
- **Overall positioning**: "Happy people, happy clients, happy stockholders." Software development and design consultancy. Known for strong employer brand and culture (won "Best Workplace in Europe" awards). Serves mid-to-large enterprises. Focus on custom software, cloud, and design.
...
- **URL**: https://www.gofore.com
- **HQ**: Tampere, Finland (offices in Helsinki, Jyvaskyla, Turku, and internationally)
- **Size**: ~1,400 people. Publicly traded on Nasdaq Helsinki. Revenue approx. EUR 170-200M.
- **Overall positioning**: "Ethical digital transformation." Strong in public sector and regulated industries. Consulting, design, and technology services. Known for transparency (publishes employee satisfaction data). The largest Finnish-origin digital consultancy by headcount.
...
- **HQ**: Helsinki, Finland (offices across Nordics and Europe)
- **Size**: ~500-600 people.
- **Overall positioning**: DevOps and software development lifecycle consultancy. The "DevOps house" of the Nordics. Sells Atlassian and DevOps tooling alongside consulting.
...
## 8. Wunderman Thompson / VMLY&R (now VML) Finland

- **URL**: https://www.vml.com (global); Finland office in Helsinki
- **Size**: Part of a global network (WPP); Finland office ~100-200 people
- **Overall positioning**: Creative and technology consultancy (part of WPP). Serves large brands. Marketing technology, CX, and creative. The Helsinki office inherits global capabilities but is primarily a marketing/creative operation.
...
| Firm | Size | AI Focus | Agentic AI | Training Products | Network/Curation Model | Threat Level |
|------|------|----------|------------|-------------------|----------------------|--------------|
| Reaktor | ~750 | Strong (Data & AI practice, Uni Helsinki research) | None visible | Elements of AI (awareness, not capability) | No | Low |
| Futurice | ~700 | Moderate (embedded in transformation) | None visible | No | No | Low |
| Columbia Road | ~150 | Minimal (AI in e-commerce) | None visible | No | No | None |
| Siili Solutions | ~1,000 | Strong ("AI-driven" brand) | None visible | No | No | Low |
| Vincit | ~550 | Moderate | None visible | No | No | None |
| Gofore | ~1,400 | Moderate | None visible | Some (not AI) | No | None |
| Eficode | ~550 | Emerging | None visible | Yes (DevOps training) | No | Low-Medium (has training mechanics) |
| VML Finland | ~150 | Minimal (marketing AI) | None visible | No | No | None |

---

## Round 2 — 2026-02-15 — Finnish Corporate Training Buyers + Flagged Firms

**Sources**: Web searches for "Aalto EE executive education AI training Hanken SSE executive education Nordic Business Forum Finland corporate training 2025 2026" and "Solita Finland AI consultancy agentic AI Renessai AI company Finland offerings training 2025 2026"; aaltoee.fi; solita.fi; renessai.com; company knowledge.

---

## 9. Aalto EE (Aalto Executive Education)

- **URL**: https://www.aaltoee.fi/en
- **HQ**: Helsinki / Espoo, Finland (Aalto University campus). International delivery in Singapore, South Korea, and custom programs globally.
- **Size**: Part of Aalto University. ~7,000 participants/year from ~1,000 organizations. Estimated revenue EUR 30-50M. One of the largest executive education providers in the Nordics.
- **Overall positioning**: Premier Finnish executive education institution. Full-spectrum business education: leadership, strategy, finance, digital transformation. AACSB-accredited via Aalto University School of Business. Strong brand with Finnish enterprise L&D buyers — the default provider when a Finnish HR team needs a partner for leadership development or business skill programs. Competes globally in open enrollment and custom corporate programs.
- **AI/ML offerings**: Multiple AI-focused programs launched 2024-2026:
  - "AI for Leaders and Decision-Makers" — strategic AI training for executives, focuses on business implications and AI implementation, built on decades of practical AI experience.
  - "Data, Analytics, and AI for Professionals" — deeper technical track on applying data/analytics/AI in business contexts.
  - "Digital Strategy, AI, and Data-Driven Business" — broader program linking digital strategy with AI and data.
  - "AI and Digital Business" — appears to be a program track or theme category.
  - "Future Considerations of AI" — forward-looking program, likely covers ethics, societal impact, and strategic planning around AI.
  - "AI and Data" — shorter format AI+data program.
  - Hosts CDOIQ Symposium (Chief Data Officer / Information Quality) in Helsinki — the second Nordic edition was Feb 2026. This positions Aalto EE as a convener of data/AI leaders.
...
- **URL**: https://www.hankensse.fi (also associated with Hanken School of Economics and Stockholm School of Economics)
- **HQ**: Helsinki, Finland (with Stockholm School of Economics connection)
- **Size**: Smaller than Aalto EE. Part of Hanken School of Economics. Estimated ~1,000-2,000 participants/year. Focused primarily on Finnish and Nordic markets.
- **Overall positioning**: Executive education with a Swedish-language Finnish and Nordic business tradition. Strong in finance, management, and leadership. More boutique and selective than Aalto EE. Attracts senior executives from Swedish-speaking Finnish companies and Nordic organizations. The "Hanken" brand carries weight especially in banking, finance, and Nordic corporate circles.
- **AI/ML offerings**: Limited publicly visible AI-specific programs. Hanken & SSE offers programs in digital transformation and strategy that touch on AI, but it does not have a dedicated AI training portfolio comparable to Aalto EE's. The institution's strength is traditional business education (strategy, leadership, finance), not technology.
...
## 11. Nordic Business Forum

- **URL**: https://www.nbforum.com
- **HQ**: Helsinki / Jyvaskyla, Finland
- **Size**: Events draw 7,000+ attendees (the Helsinki flagship event is one of the largest business conferences in Europe). Small operating company (~30-50 staff).
- **Overall positioning**: Premium business conference and leadership event producer. The "flagship" is Nordic Business Forum Helsinki — a two-day annual event with globally famous speakers (past speakers: Barack Obama, Al Gore, Brene Brown, Simon Sinek). Positioned as "the most important business event of the year" for Nordic executives. Brand is aspirational, premium, and focused on inspiration rather than skill-building. Additional smaller events (NBF Unscripted, digital content).
- **AI/ML offerings**: AI has featured as a topic in keynotes and panels at NBF events (e.g., AI strategy, future of work with AI), but NBF does not sell AI training programs. AI is a conference topic, not a product line. NBF sells tickets and sponsorships to an annual event — it is an events business, not a training business.
...
- **HQ**: Helsinki, Finland (offices in Tampere, Turku, Oulu, and across Nordics + Europe: Sweden, Denmark, Norway, Belgium, Poland, Switzerland, Germany, UK)
- **Size**: ~2,000+ professionals. Private, owned by Apax Partners (acquired majority stake). Estimated revenue EUR 200-300M. One of the largest Finnish-origin technology consultancies.
- **Overall positioning**: "Impact that lasts." Data-driven technology consultancy. Core identity is built on data, analytics, and AI — stronger AI positioning than any other Finnish consultancy. Also does custom software development, cloud, and integration. Serves large enterprises and public sector across the Nordics. Originally "the data company" in Finland. More technical and data-centric than Reaktor or Futurice.
- **AI/ML offerings**: Deep and broad. Solita positions AI as a core pillar, not an add-on:
  - AI strategy and consulting
  - Machine learning and data science
  - Generative AI services — dedicated genAI service line, including "Solita FunctionAI" (a platform/product for safe enterprise AI deployment, supporting OpenAI GPT, Anthropic Claude, Google Gemini; enterprise-grade security and controls)
  - Data platform development
  - AI-powered software development practices
  - Solita has publicly stated increased investment in generative AI
...
- **URL**: https://www.renessai.com
- **HQ**: Helsinki, Finland
- **Size**: ~14 employees (per PitchBook 2026). Very small — a boutique strategic AI consultancy.
- **Overall positioning**: "Strategic AI consultancy" founded by AI pioneers. Positions itself as a strategy-first AI firm — "we don't sell technologies or software, we help clients figure out what to use AI for and how to execute plans successfully." The founders have AI/tech backgrounds and positioned the firm as advisor/strategist, not implementer. Nitor (Finnish consultancy) published an article about Renessai's founding, noting the founding team as "AI pioneers" with the firm off to a "flying start even before launch." The firm appears to be connected to the Finnish AI community — founder Eikku Koponen featured at Bird & Bird's "Women in Tech" event discussing AI innovation.
- **AI/ML offerings**: Strategic AI consulting — helping organizations develop AI strategy, assess AI opportunities, and plan AI adoption. The emphasis is on strategy, people, and process rather than building AI solutions. "Helps create strategy, guide people and processes, and enhance technology to ensure concrete outcomes that grow your business."
...
## Round 2 Summary Table (additions)

| Firm | Size | AI Focus | Agentic AI | Training Products | Network/Curation Model | Threat Level |
|------|------|----------|------------|-------------------|----------------------|--------------|
| Aalto EE | ~7,000 participants/yr | Strong (multiple AI programs) | None visible | Yes — core business (exec ed) | Alumni network (traditional) | Medium (has buyer relationship + AI programs, but academic/managerial framing) |
| Hanken & SSE | ~1,500 participants/yr | Minimal | None visible | Yes — core business (exec ed) | Alumni network (traditional) | Low |
| Nordic Business Forum | ~7,000 attendees/yr | Topical (conference talks) | None visible | No (events, not training) | Audience, not practice network | None (but valuable lead gen channel) |
| Solita | ~2,000 | Very strong (AI as core identity, FunctionAI product) | Yes — events and thought leadership on autonomous AI agents | AI master classes (consulting-embedded, not standalone) | No | Medium (most AI-capable Finnish firm, could absorb embedded training demand) |
| Renessai | ~14 | Strategic AI consulting | None visible | No | No | None (potential referral partner) |
