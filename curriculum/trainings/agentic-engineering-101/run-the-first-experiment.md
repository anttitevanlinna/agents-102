...
- mechanical: pending re-run on tmux-runner (ae101-m4; old bin/judge.sh runner decommissioned 2026-05-31, prior PASS @e840433 no longer counts — predates later edits)
